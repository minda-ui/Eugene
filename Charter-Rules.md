...
Added 2026-09-20, owner ruling via Alex (HL-0023/AWT-0036/AWT-0040); Rule C added 2026-09-22 via
Victoria. Governs how Eugene uses the group **AI Workforce Hub** (`CLAUDE.md` §2e).
...
- **Rule C — plain-brief.** Say it in fewer words: lead with the answer or the ask; cut preamble, filler,
